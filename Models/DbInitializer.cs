...
{
    public static void Seed(BethanyPieShopDbContext context)
    {
            ...
            context.AddRange(
                new Pie
                {
                    ...
                    LongDescription =
                        ...
                        "candy tootsie roll. Chocolate cake gingerbread tootsie roll oat cake pie chocolate bar cookie" +
                        " dragée brownie. Lollipop cotton candy cake bear claw oat cake. Dragée candy canes dessert " +
                        "tart. Marzipan dragée gummies lollipop jujubes chocolate bar candy canes. Icing gingerbread " +
                        "chupa chups cotton candy cookie sweet icing bonbon gummies. Gummies lollipop brownie biscuit " +
                        "danish chocolate cake. Danish powder cookie macaroon chocolate donut tart. Carrot cake " +
                        "dragée croissant lemon drops liquorice lemon drops cookie lollipop toffee. Carrot cake carrot" +
                    ...
                    {
                        new() { Name = "Sugar", Amount = "100 gram" },
